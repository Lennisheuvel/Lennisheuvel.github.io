 ...
 * @ingroup Skins
 */
class SkinLennisSkin extends SkinTemplate {
	/** Using monobook. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'LennisSkin';
		$this->stylename = 'LennisSkin';
		$this->template  = 'LennisSkinTemplate';
 ...
 * @ingroup Skins
 */
class LennisSkinTemplate extends QuickTemplate {
	var $skin;
	/**
